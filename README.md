...
- ✅ **슬라이딩 윈도우**: 자동으로 진행에 따라 악보가 넘어갑니다 (좁은 화면: 1개 마디, 넓은 화면: 2개 마디)
- ✅ **Safe Area 지원**: iPhone notch/Dynamic Island 영역 자동 회피
...
### 📋 iPhone 가로 모드 최적화 (v0.2.0)
최근 업데이트로 iPhone 가로 모드 사용성이 크게 개선되었습니다:
- ✨ **마디 자동 이동**: 현재 연주 중인 마디만 표시 (겹침 없음)
- ✨ **정확한 하이라이트**: 목표 음표와 하이라이트 위치 정확히 일치
- ✨ **Dynamic Island 지원**: notch/island 영역 자동 회피
- ✨ **키보드 최적화**: 소프트 키보드가 잘리지 않고 완전히 표시

상세 내용은 [TESTING.md](./TESTING.md) 및 [TECHNICAL_ANALYSIS.md](./TECHNICAL_ANALYSIS.md) 참조.
